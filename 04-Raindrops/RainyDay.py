...
class Raindrop:
    def __init__(self, screen, x, y):
        ...
        # dTODO 8: Initialize this Raindrop, as follows:
        #     - Store the screen.
    ...
    def move(self):
        ...
        # dTODO 11: Change the  y  position of this Raindrop by its speed.
        self.y = self.y + self.speed

    def off_screen(self):
        """ Returns true if the Raindrop y value is not shown on the screen, otherwise false. """
        # Note: this will be used for testing, but not used in the final version of the code for the sake of simplicity.
        # dTODO 13: Return  True  if the  y  position of this Raindrop is greater than 800.
        return self.y > self.screen.get_height()

    def draw(self):
        """ Draws this sprite onto the screen. """
        # dTODO 9: Draw a vertical line that is 5 pixels long, 2 pixels thick,
...
class Hero:
    def __init__(self, screen, x, y, with_umbrella_filename, without_umbrella_filename):
        ...
        # dTODO 16: Initialize this Hero, as follows:
        #     - Store the screen.
    ...
    def draw(self):
        """ Draws this sprite onto the screen. """
        # dTODO 17: Draw (blit) this Hero, at this Hero's position, WITHOUT an umbrella:
        # dTODO 21: Instead draw (blit) this Hero, at this Hero's position, as follows:
    ...
    def hit_by(self, raindrop):
        ...
        # dTODO 19: Return True if this Hero is currently colliding with the given Raindrop.
...
class Cloud:
    def __init__(self, screen, x, y, image_filename):
        ...
        # dTODO 24: Initialize this Cloud, as follows:
        #     - Store the screen.
    ...
    def draw(self):
        """ Draws this sprite onto the screen. """
        # dTODO 25: Draw (blit) this Cloud's image at its current position.
        self.screen.blit(self.image,(self.x, self.y))
        pass

    def rain(self):
        """ Adds a Raindrop to the array of raindrops so that it looks like the Cloud is raining. """
        # dTODO 28: Append a new Raindrop to this Cloud's list of raindrops,
...
def main():
    ...
    # dTODO 1: Initialize the game, display a caption, and set   screen   to a 1000x600 Screen.
    pygame.init()
    screen = pygame.display.set_mode(  (1000,600)  )
    pygame.display.set_caption("Rainy day")
    # doneTODO 2: Make a Clock
    clock = pygame.time.Clock()
    # dTODO 7: As a temporary test, make a new Raindrop called test_drop at x=320 y=10
   #test_drop = Raindrop(screen, 320, 10)
    # dTODO 15: Make a Hero, named mike, with appropriate images, starting at position x=200 y=400.
    mike = Hero(screen, 200, 400, "Mike_umbrella.png", "Mike.png")
    # dTODO 15: Make a Hero, named alyssa, with appropriate images, starting at position x=700 y=400
    Alyssa = Hero(screen, 700, 400, "Alyssa_umbrella.png", "Alyssa.png")
    # dTODO 23: Make a Cloud, named cloud, with appropriate images, starting at position x=300 y=50.
    cloud = Cloud(screen, 200, 50, "cloud.png")
    # dTODO 3: Enter the game loop, with a clock tick of 60 (or so) at each iteration.
    while True:
        clock.tick(60)
        # dTODO 4:   Make the pygame.QUIT event stop the game.
        ...
        if pressed_keys[pygame.K_LEFT]:
            cloud.x = cloud.x - 5
        # dTODO 27: Inside the game loop (AFTER the events loop above), get the list of keys that are currently pressed.
        ...
        # dTODO 5: Inside the game loop, draw the screen (fill with white)
        screen.fill((255,255,255))
        # --- begin area of test_drop code that will be removed later
        # dTODO 12: As a temporary test, move test_drop
        #test_drop.move()

        # dTODO 14: As a temporary test, check if test_drop is off screen, if so reset the y position to 10
        #if test_drop.off_screen():
            #test_drop.y = 10
        # dTODO 10: As a temporary test, draw test_drop

        #test_drop.draw()
        # dTODO 20: As a temporary test, check if test_drop is hitting Mike (or Alyssa), if so set their last_hit_time
        ...
        # dTODO 26: Draw the Cloud.
        cloud.draw()

        # dTODO 29: Remove the temporary testdrop code from this function and refactor it as follows:
        # dTODO: Make the Cloud "rain", then:
        # dTODO    For each Raindrop in the Cloud's list of raindrops:
            #       - move the Raindrop.
            #       - draw the Raindrop.
            # dTODO  30: if the Hero (Mike or Alyssa) is hit by a Raindrop, set the Hero's last_time_hit to the current time.
        ...
        for raindrop in cloud.raindrops:
            ...
            if raindrop.off_screen():
                cloud.raindrops.remove(raindrop)
        # dTODO 18: Draw the Heroes (Mike and Alyssa)
        mike.draw()
        Alyssa.draw()
        # dTODO 6: Update the display and remove the pass statement below
        pygame.display.update()
    pass


# doneTODO 0: Call main.
main()