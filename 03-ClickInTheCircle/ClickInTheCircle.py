...
def distance(point1, point2):
    ...
    # doneTODO 4: Return the actual distance between point 1 and point 2.
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                click_pos = event.pos
            #doneTODO 2: For a MOUSEBUTTONDOWN event get the click position.

                # doneTODO 3: Determine the distance between the click position and the circle_center using the distance
                distance_from_circle = distance(circle_center, click_pos)
                # doneTODO 3:   function and save the result into a variable called distance_from_circle

                # doneTODO 5: If distance_from_circle is less than or equal to circle_radius, set message_text to 'Bullseye!'
                if distance_from_circle <= circle_radius:
                    message_text = 'bullseye!'
                    pygame.mixer.music.play()
                else:
                    message_text = 'you missed!'
                # doneTODO 5: If distance_from_circle is greater than the circle_radius, set the message_text to 'You missed!'
        ...
        # doneTODO 1: Draw the circle using the screen, circle_color, circle_center, circle_radius, and circle_border_width
